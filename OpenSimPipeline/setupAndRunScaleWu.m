...
ScaledModelFile=[Path.exportPath Alias.sujet{isujet} 'WuScaled.osim'];
ScaleSetFile=[Path.exportPath Alias.sujet{isujet} 'WuScaleSet.xml'];
ScaleModelNewMKRFiler=[Path.exportPath Alias.sujet{isujet} 'WuNewMKR.osim'];
scaleTool.setName([Alias.sujet{isujet} 'Wuscaled']);
...
outfile = ['Setup_ScaleWu' Alias.sujet{isujet} '.xml'];
