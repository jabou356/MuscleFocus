...
SCjoint=MyJointSet.get('SCJ');
SCjointID=MyJointSet.getIndex('SCJ');
...
%Update the joint CS
ACjoint=MyJointSet.get('ACJ');
ACjointID=MyJointSet.getIndex('ACJ');
...
GHjoint0=MyJointSet.get('GHJ');
GHjoint0ID=MyJointSet.getIndex('GHJ');
...
GenericModel.print([Path.OpensimSetupJB, 'Wu_Shoulder_Model_adapted.osim']);
