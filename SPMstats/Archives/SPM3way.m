...
SUBJ=repmat(1:2*npergroup,1,12);
...
B=[repmat(0,1,npergroup*2*6), repmat(1,1,npergroup*2*6)];

C=[repmat(0,1,npergroup*2), repmat(1,1,npergroup*2)...
   repmat(2,1,npergroup*2), repmat(3,1,npergroup*2)...
   repmat(4,1,npergroup*2), repmat(5,1,npergroup*2)];
C=repmat(C,1,2);
...
%(2) Plot:
close all;
FFni.plot('plot_threshold_label',true, 'plot_p_values',true, 'autoset_ylim',false);
